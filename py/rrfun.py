...
__Website__ = f"https://henral.github.io/{__repo_name__}/"
...
class root:
    def __init__(self, argv, Author, Author_tag_name, Github, Github_link, Website, disclaimer, watermark, Version, soft_name, repo_name):
...
RI=(sys.argv, __Author__, __Author_tag_name__, __Github__, __Github_link__, __Website__, __disclaimer__, __watermark__, __Version__, __soft_name__, __repo_name__)
main(RI)